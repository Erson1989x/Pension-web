...
export const rooms = [
  {
    ...
    longDescription: 'Bucurați-vă de priveliștea spectaculoasă a munților din această cameră elegantă. Dotată cu un pat king-size confortabil si o canapea extensibila, baie comună si bucatarie comună, perfecte pentru a savura cafeaua de dimineață în mijlocul naturii.',
    price: 195,
    size: '45 m²',
  ...
  },
  {
    ...
    longDescription: 'Perfecta pentru familii, această cameră oferă spațiu generos și toate facilitățile necesare pentru un sejur confortabil in inima naturii.',
    price: 173,
    size: '38 m²',
    capacity: '2 persoane',
  ...
  },
  {
    ...
    longDescription: 'Bucurați-vă de priveliștea spectaculoasă a munților din această cameră elegantă. Dotată cu un pat king-size confortabil, baie privata si bucatarie comună, perfecta pentru a savura cafeaua de dimineață în mijlocul naturii.',
    price: 197,
    size: '38 m²',
    capacity: '2 persoane',
