          ...
          >
            ...
            <div className="flex space-x-4">
              <Link href="https://facebook.com" aria-label="Facebook">
                <div className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-600 transition-colors">
              ...
              <Link href="https://instagram.com" aria-label="Instagram">
                <div className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-pink-600 transition-colors">
              ...
              <Link href="https://twitter.com" aria-label="Twitter">
                <div className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-400 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="white">
